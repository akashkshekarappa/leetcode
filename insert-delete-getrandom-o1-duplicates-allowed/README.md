<h2>381. Insert Delete GetRandom O(1) - Duplicates allowed</h2><h3>Hard</h3><hr><div><p>Design a data structure that supports all following operations in <i>average</i> <b>O(1)</b> time.</p>
